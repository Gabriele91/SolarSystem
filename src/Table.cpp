	...
	for(auto value :  *this ){
		...
		case SolarSystem::Table::MATRIX4X4:
			outtextfile+=value.second->get<Matrix4x4>().toString("(",
																 ...
																 ")\n");
			break;
		case SolarSystem::Table::STRING:
			outtextfile+=String::toString('\"')+value.second->get<String>()+"\"\n";
			break;
		case SolarSystem::Table::BINARY:
			//to do
			break;
		case SolarSystem::Table::TABLE:
